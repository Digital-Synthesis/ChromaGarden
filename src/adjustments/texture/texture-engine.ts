// src/adjustments/texture/texture-engine.ts

export interface TextureEngineParams {
...
export function applyTextureEngine(
  imageData: ImageData,
  ...
  const strength = amount * 2.0; // stronger than clarity
